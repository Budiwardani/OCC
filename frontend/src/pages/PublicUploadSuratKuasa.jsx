                    ...
                    {status === "success" ? (
                        ...
                        <form className="space-y-6" onSubmit={handleUpload}>
                            <div>
                                ...
                                <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm" />
                            </div>
                            <div>
