...
export default function ComplaintDetail() {
    ...
    const handleSendWhatsApp = async () => {
        if (!complaint.phone) return alert("Customer has no phone number");
        ...
        const uploadLink = `${window.location.origin}/upload-surat/${complaint.ticket_code}`;
        const msg = `Hello, your ticket #${complaint.ticket_code} status is now ${complaint.status}.${templateLink}\n\nPlease sign the document and upload it here: ${uploadLink}`;

        const url = `https://wa.me/${complaint.phone.replace(/^0/, '62').replace(/[^0-9]/g, '')}?text=${encodeURIComponent(msg)}`;
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-1 flex rounded-md shadow-sm">
                                                <input
                                                    type="text"
                                                    readOnly
                                                    value={`${window.location.origin}/upload-surat/${complaint.ticket_code}`}
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        navigator.clipboard.writeText(`${window.location.origin}/upload-surat/${complaint.ticket_code}`);
                                                        alert("Link copied!");
                                                    }}
                                    ...
                                    <div className="bg-white shadow rounded-lg p-6">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <button
                                                ...
                                                className="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none"
                                            >
